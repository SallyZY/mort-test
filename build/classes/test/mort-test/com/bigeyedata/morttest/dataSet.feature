...
#      |  DirectoryName  |  ResourceFileName     |
#      |  测试数据集目录   |  测试CSV数据集         |
#    When I click "Delete" item from dropdown menu of "测试CSV数据集"
#    Then I should NOT see deleted resource file "测试CSV数据集" in directory
...
#  Scenario Outline: Append data to an existed dataset
#
#    Given I access to "dataset" module
#    And I select dataset as following
#      |  DirectoryName  |  ResourceFileName     |
#      |  测试数据集目录   |  测试CSV数据集         |
#    And  I click "AppendData" item from other operation dropdown menu
